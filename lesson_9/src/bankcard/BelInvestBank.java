...
public class BelInvestBank implements DebitCard, CreditCard {
    private final int COMISSION = 2;
    private double interestRate = 13;
    private String serialNumber;
    private double balance;
    private double loan;

    public BelInvestBank(String serialNumber, double balance) {
    ...
    public void withdraw(double value) {
        value = value + (value * (COMISSION / 100));
        balance -= value;
